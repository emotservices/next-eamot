...
const strings = ["Energy Management", "Asset Maintenance", "Field Service"];
        ...
        <div className="row">
          <div className="col-12">
            <div className="content text-center">
              <h6>Enterprise Asset Management Platform</h6>
              <h1>
              ...
              <p>
                ...
                featuring EMaaS, CMMS, and Field Service solutions. <br />
                Optimize energy consumption, maintain assets efficiently, and
                manage field operations seamlessly.
              </p>
      ...
      <div className="themesflat-container full">
        <div className="row">
          <div className="col-12 text-center">
            <Image
              src="/assets/images/home/home-4.jpg"
              width={1440}
              height={1024}
              alt="image"
            />
